...
//		System.out.println("##########################################here###################################3");
			...
			PlatformUI.getWorkbench().getProgressService().busyCursorWhile(new IRunnableWithProgress() {
				...
				throws InvocationTargetException, InterruptedException {
					...
					try
					{
						...
						String namespace = ns;
						monitor.worked(10);
						IWemListenerModified listener = new PrintPropertyListener(newPrinter(buf), namespace, Reasoning.rdfs,dir,names);
						try {
	...
	public static Model quickReturnParsedModel(final String text,final String dir,final String[] names,final String ns) {				
		IWemListenerModified listener = new PrintPropertyListener(newPrinter(new StringBuffer()), ns, Reasoning.rdfs,dir,names);
		try {
